...
import Uebung36.datenbank.connection.SQLiteDatenbankverbindung;
    ...
    private void upgrade(int oldDBVersion) throws SQLException {
        ...
        switch(oldDBVersion) {
            case 0: {
                ...
                result = execute(SqlStatements.CREATE_TELEFONBUCH);
            ...
            case 1: {
                ...
                result = result && execute(SqlStatements.CREATE_VIEW_TELEFONBUCH);
            ...
            case 2: {
                ...
                result = result && execute(SqlStatements.CREATE_TRIGGER_TELEFONBUCH_INS);
                result = result && execute(SqlStatements.CREATE_TRIGGER_TELEFONBUCH_UPD);
                result = result && execute(SqlStatements.CREATE_TRIGGER_TELEFONBUCH_DEL);
